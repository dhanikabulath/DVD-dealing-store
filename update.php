...
<div id="content">
  <div id="frame_head">Update Employee Form</div>
    ...
    if(isset($_POST['button2'])){
        ...
        $sql ="SELECT * FROM tb_emp WHERE emp_name='$emp_name1'";
        $result1=mysqli_query($conn,$sql);
        $row = $result1->fetch_assoc();

        if(($user_pw1==$row['user_pw']) &&($type_pw1==$type_pw2)  ){
            $sql = "UPDATE tb_emp SET emp_name='$emp_name1', nic='$nic1', emp_email='$emp_email1',user_name='$user_name1', user_pw='$user_pw1' WHERE emp_id ='$emp_id' ";
            //echo $sql;
